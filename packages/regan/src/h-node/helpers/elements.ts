// import {getElFromDomPointer} from '../../utils/dom.ts';
// import {HNodeElement} from '../element.ts';
// import {HNode} from '../h-node.ts';

// const detectElemParentIndex = (el: ChildNode): number => {
...
//   const parentIndex = detectElemParentIndex(
//     getElFromDomPointer(hNodeElement.domPointer)
//   );
