...
[strangelove](https://www.npmjs.com/package/strangelove) (от 2.1.6: `Atom` —
...
- **`src/utils/props.ts`** — разделение статических, динамических и связанных
  пропов, подписка на атом в пропе и обратная запись в атом. **`bind.ts`** —
  `unbind`, отмена обратной записи.
